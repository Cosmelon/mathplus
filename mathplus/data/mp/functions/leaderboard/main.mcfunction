...
execute as @a if score @s mp_indiv = $p1 mp_indiv run tag @s remove lb_p2
execute as @a if score @s mp_indiv = $p1 mp_indiv run tag @s remove lb_p3
execute as @a if score @s mp_indiv = $p1 mp_indiv run tag @s remove lb_p4
execute as @a if score @s mp_indiv = $p1 mp_indiv run tag @s remove lb_p5
...
execute as @a if score @s mp_indiv = $p2 mp_indiv run tag @s remove lb_p1
execute as @a if score @s mp_indiv = $p2 mp_indiv run tag @s remove lb_p3
execute as @a if score @s mp_indiv = $p2 mp_indiv run tag @s remove lb_p4
execute as @a if score @s mp_indiv = $p2 mp_indiv run tag @s remove lb_p5
...
execute as @a if score @s mp_indiv = $p3 mp_indiv run tag @s remove lb_p1
execute as @a if score @s mp_indiv = $p3 mp_indiv run tag @s remove lb_p2
execute as @a if score @s mp_indiv = $p3 mp_indiv run tag @s remove lb_p4
execute as @a if score @s mp_indiv = $p3 mp_indiv run tag @s remove lb_p5
...
execute as @a if score @s mp_indiv = $p4 mp_indiv run tag @s remove lb_p1
execute as @a if score @s mp_indiv = $p4 mp_indiv run tag @s remove lb_p2
execute as @a if score @s mp_indiv = $p4 mp_indiv run tag @s remove lb_p3
execute as @a if score @s mp_indiv = $p4 mp_indiv run tag @s remove lb_p5
...
execute as @a if score @s mp_indiv = $p5 mp_indiv run tag @s remove lb_p2
execute as @a if score @s mp_indiv = $p5 mp_indiv run tag @s remove lb_p3
execute as @a if score @s mp_indiv = $p5 mp_indiv run tag @s remove lb_p4
